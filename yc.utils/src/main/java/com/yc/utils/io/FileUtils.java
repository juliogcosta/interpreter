...
public class FileUtils
{
    ...
    public File forceWriteFile(byte[] content, String filename) throws IOException
    {
        File file = new File(filename);
    ...
    public String getDataFileFromClassLoader(String fileName)
    {
        ...
        try
        {
            result = this.readInputStream(Thread.currentThread().getContextClassLoader().getResourceAsStream(fileName));
        }
        catch (Exception e)
        {
            e.printStackTrace();
