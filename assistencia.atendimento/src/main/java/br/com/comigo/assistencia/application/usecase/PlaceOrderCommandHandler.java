...
public interface PlaceOrderCommandHandler extends CommandHandler<SolicitarAtendimentoCommand> {
   ...
   *
   */
  void handle(Aggregate aggregate, SolicitarAtendimentoCommand command);
