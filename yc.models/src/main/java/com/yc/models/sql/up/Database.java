...
public class Database implements Serializable
{
    ...
    public Boolean getEnableNoSql()
    {
        return enableNoSql;
    }

    public void setEnableNoSql(Boolean enableNoSql)
    {
        this.enableNoSql = enableNoSql;
    }
    ...
    {
        return "ExternalDbConn [id=" + id + ", owner=" + owner+ ", dbsqlname=" + dbsqlname + ", dbsqlusername="
