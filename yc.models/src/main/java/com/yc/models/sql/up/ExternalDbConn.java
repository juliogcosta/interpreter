...
public class ExternalDbConn implements Serializable
{
    /**
     * 
     */
    ...
    public ExternalDbConn() 
    {
    }

    public ExternalDbConn(Long id, 
            Project project,  
            String dbSqlName,
    ...
    {
        return "ExternalDbConn [id=" + id + ", project=" + project + ", dbsqlname=" + dbsqlname + ", dbsqlusername="
