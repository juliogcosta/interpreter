...
public final class DisponibilizarServicoCommand extends Command {

    private final String nome;
    private final String descricao;
    private final Boolean certificacaoIso;

    public DisponibilizarServicoCommand(ServicoDTO servicoDTO) {
        super(AggregateType.SERVICO.toString(), generateAggregateId());
