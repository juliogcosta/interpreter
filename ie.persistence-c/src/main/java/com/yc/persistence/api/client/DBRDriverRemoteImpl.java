...
public class DBRDriverRemoteImpl
{
    ...
    public void executeStatements(String traceId, String spanId, String parentSpanId, String tenantId, String data) throws Exception
    {
        final ResponseEntity<String> responseEntity = this.clientRest.dsExecuteStatements(traceId, spanId, parentSpanId, tenantId, data.toString());
        if (responseEntity.getStatusCode() != HttpStatus.OK)
        {
            throw new Exception(responseEntity.getBody());
        }
