...
public class URLFilter implements Filter
{
    ...
    public void setSchemaCache(SchemaCacheServiceImpl schemaCacheService)
    {
            ...
            FilterChain filterChain) throws IOException, ServletException
    {
        ...
        catch (Exception e)
        {
            ...
            {
                JSONObject jsError = this.errorLogger.buildErrorMessage("yc.persistence-c", 
                        e, 
                        tenantId, 
                        xB3TraceId, 
                        xB3SpanId, 
            ...
            JSONObject validTenantId) throws Exception
    {
        ...
        //logger.info(" > responseEntity.getBody(): "+responseEntity.getStatusCode());
        ...
        if (responseEntity.getStatusCode() == HttpStatus.OK)
        {
            ...
            {
                deployedEntities = new JSONObject();
            }
            ...
            /*if (isContract) 
            {
                this.addDataSchema(tenantId, 
                        jsDataSchema.getJSONObject("project").getString("owner")
            ...
            {*/
                //JSONObject jsContract = this.getContract(id, spanId, parentSpanId, jsDataSchema.getString("owner"), httpMethod, httpEndpoint);
            ...
            this.addDataSchema(traceId, spanId, parentSpanId, tenantId, 
                ...
                //logger.info(" > this.contextManagerControl.getLogConsole("+tenantId+"): "+this.contextManagerControl.getLogConsole(tenantId));
            //}
        }
        else
        {
            ...
            String httpEndpoint) throws Exception
    {
        ...
        for (int idx = 0; idx < jsContracts.length(); idx++)
        {
            ...
            if (count > 1) 
            {
                throw new Exception("510:this org '".concat(orgName).concat("' has more than one contract active."));
            }
        }
